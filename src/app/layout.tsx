...
export const metadata: Metadata = {
  title: {
    default: "Sundarban Riders — WhatsApp CRM & Management",
    template: "%s — Sundarban Riders",
  },
  description: "Sundarban Riders (সুন্দরবন রাইডার) — WhatsApp Concierge, Customer Relations, Broadcasts & Management.",
  robots: {
    index: false,
    follow: false,
  },
